...
function change(user) {
    if (typeof(Storage) !== "undefined") {
        ...
        alert("Sorry! You will not be able to use your GuideSRC account on this device as it does not support HTML5 web storage.");
    }
}
...
function shareProfile() {
    ...
    $(".shareProfileLink").val("https://guidesrc.github.io/profile.html?user=" + currentUid);
}
